...
Brewster angle of fused silica (a common optical material) at a few key
wavelengths.
"""
...
def refl_fs(theta, n):
    ...
    amp_refl = materials.calc_fresnel_reflectivity(theta*pi/180, 1, n)
...
for wvlnt in wvlnts:
    ...
    res = minimize(lambda x: refl_fs(x, n)[1], 55)
    # Store the result
