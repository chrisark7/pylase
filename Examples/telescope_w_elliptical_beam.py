...
os.add_thin_lens(f=150e-3, z=300e-3, label='lens 2')

# Add two beams
os.add_beam_from_parameters(waist_size=0.1e-3, distance_to_waist=0, wvlnt=1064e-9, z=0, beam_label='x')
os.add_beam_from_parameters(waist_size=0.2e-3, distance_to_waist=0, wvlnt=1064e-9, z=0, beam_label='y')
